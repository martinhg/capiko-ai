...
#
# Or download and run:
#   curl -sLO https://raw.githubusercontent.com/martinhg/capiko-ai/main/scripts/install.sh
#   chmod +x install.sh
#   ./install.sh
# ============================================================================
...
BREW_TAP="martinhg/homebrew-tap"
...
# Examples:
#   capiko-ai_1.0.0_darwin_arm64.tar.gz
#   capiko-ai_1.0.0_linux_amd64.tar.gz
# ============================================================================
...
print_banner() {
    echo ""
    echo -e "${CYAN}${BOLD}"
    echo "   ___ __ _ _ __ (_) | _____         __ _(_)"
    echo "  / __/ _\` | '_ \\| | |/ / _ \\ _____ / _\` | |"
    echo " | (_| (_| | |_) | |   < (_) |_____| (_| | |"
    echo "  \\___\\__,_| .__/|_|_|\\_\\___/       \\__,_|_|"
    echo "           |_|                              "
    echo -e "${NC}"
    echo -e "  ${DIM}capiko-ai — the capiko layer for GitHub Copilot CLI${NC}"
    echo ""
}
...
print_next_steps() {
    ...
    echo -e "  ${CYAN}1.${NC} Run ${BOLD}${BINARY_NAME}${NC} to start the TUI configurator"
    echo -e "  ${CYAN}2.${NC} Select the skills and tools to mount onto Copilot CLI"
